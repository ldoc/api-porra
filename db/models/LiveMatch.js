...
const liveMatchSchema = new mongoose.Schema({
  ...
  incidents: { type: [new mongoose.Schema({ key: String, tipo: { type: String, enum: ['sub', 'card'] }, minuto: Number, teamId: Number, playerId: Number, playerName: String, playerOut: String, playerOutId: Number, color: String }, { _id: false })], default: [] },
